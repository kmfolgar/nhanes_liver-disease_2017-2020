...
exposures <- c("education", "access_healthcare", "poverty",
                      "waist_to_hip_cat", "bmi2", "diabetes", "viral", "alcohol_variable")
...
## Supplemental Table 2: Sensitivity BMI - Waist to Hip 
...
list(model_1a_table, model_1b_table,
     model_2a_table, model_2b_table,
     model_3a_table, model_3b_table) %>% 
  reduce(merge, by="race") %>% t() %>% 
  as.data.frame() %>% 
  row_to_names(1)  -> table2_appendix
